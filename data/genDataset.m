...
for i = 1:num_responses
    ...
    participant_mturk_code = str2num_(participant_data.mTurkCode{1});
    participant_prediction_task = str2num_(participant_data.randNumber{1});
    participant_videos_order_raw = participant_data.FL_15_DO{1};
    participant_videos_order = [str2num_(participant_videos_order_raw(19)), ...
                                str2num_(participant_videos_order_raw(39)), ...
                                str2num_(participant_videos_order_raw(59)), ...
                                str2num_(participant_videos_order_raw(79))];
                            
    participant_videos_order = setdiff(participant_videos_order, participant_prediction_task, 'stable');
    
    participant_fail_succ = [str2num_(participant_data.fail_succ_1{1}), ...
                             str2num_(participant_data.fail_succ_2{1}), ...
                             str2num_(participant_data.fail_succ_3{1}), ...
                             str2num_(participant_data.fail_succ_4{1})];
    
    %% sensing check
    sensing_diff_order = [str2num_(participant_data.Sens_1_1{1}), ...
                          str2num_(participant_data.Sens_1_2{1}), ...
                          str2num_(participant_data.Sens_1_3{1}), ...
                          str2num_(participant_data.Sens_1_4{1})];
    
                      
    sensing_capabilities = 0.1 * [str2num_(participant_data.Sens_2_1{1}), ...
                                  str2num_(participant_data.Sens_2_2{1}), ...
                                  str2num_(participant_data.Sens_2_3{1}), ...
                                  str2num_(participant_data.Sens_2_4{1})];
...
%             disp('But there are equal sensing capabilities.');
    ...
    %% processing check
    processing_diff_order = [str2num_(participant_data.Proc_1_1{1}), ...
                             str2num_(participant_data.Proc_1_2{1}), ...
                             str2num_(participant_data.Proc_1_3{1}), ...
                             str2num_(participant_data.Proc_1_4{1})];
    
    processing_capabilities = 0.1 * [str2num_(participant_data.Proc_2_1{1}), ...
                                     str2num_(participant_data.Proc_2_2{1}), ...
                                     str2num_(participant_data.Proc_2_3{1}), ...
                                     str2num_(participant_data.Proc_2_4{1})];
...
%         disp(i);
    ...
    for j = 3:5
        if ~strcmp(participant_trust_1{1, j}{1}, '')
            trust_prediction_1 = str2num_(participant_trust_1{1, j}{1});
        end
    end
...
%         disp(i);
    ...
    for j = 3:5
        if ~strcmp(participant_trust_2{1, j}{1}, '')
            trust_prediction_2 = str2num_(participant_trust_2{1, j}{1});
        end
    end
...
%         disp(i);
    ...
    for j = 3:5
        if ~strcmp(participant_trust_3{1, j}{1}, '')
            trust_prediction_3 = str2num_(participant_trust_3{1, j}{1});
        end
    end
